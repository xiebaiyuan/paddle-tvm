(function (global, factory) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.createWebSocket = exports.getPeformance = void 0;
	/**
	...
	class Instance {
	    ...
	    registerEnvGlobalPackedFuncs() {
	        ...
	        const timeExecution = (finvoke, dev, nstep, repeat, minRepeatMs) => __awaiter(this, void 0, void 0, function* () {
	        ...
	        this.registerAsyncServerFunc("tvm.rpc.server.load_module", (_args) => __awaiter(this, void 0, void 0, function* () {
	            console.log(_args);
	            console.log("tvm.rpc.server.load_module called");
	            const network = "mobilenet";
	            const graphJson = yield (yield fetch("./" + network + ".json")).text();
	            // const synset = await (await fetch("./imagenet1k_synset.json")).json();
	            const paramsBinary = new Uint8Array(yield (yield fetch("./" + network + ".params")).arrayBuffer());
	            var ctx = this.cpu(0);
	        ...
	        this.registerFunc("tvm.rpc.server.remove", (_args) => {
	            console.log(_args);
	...
	class RPCServer {
	    ...
	    initGlobalFunction(instance) {
	        instance.registerFunc("tvm.rpc.server.upload", (filenmae, databuffer) => {
